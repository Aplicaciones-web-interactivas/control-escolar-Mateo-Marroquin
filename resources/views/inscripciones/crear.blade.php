    ...
    <div class="max-w-2xl mx-auto px-4 py-6">
        ...
        <div class="bg-white rounded-2xl shadow-xl border border-gray-100 overflow-hidden">
            ...
            <form action="{{ route('inscripciones.guardar') }}" method="POST" class="p-8 space-y-6">
                ...
                <div>
                    ...
                    <select name="user_id"
                        ...
                        @foreach($usuarios as $u)
                            <option value="{{ $u->id }}">{{ $u->name }} ({{ $u->clave_institucional }})</option>
                        @endforeach
                    </select>
                </div>
                ...
                <button type="submit"
                        class="w-full bg-blue-600 hover:bg-blue-700 text-white py-4 rounded-xl font-bold transition shadow-lg">
