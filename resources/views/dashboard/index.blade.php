    ...
    <div class="max-w-6xl mx-auto">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <a href="{{ route('materias.index') }}"
               class="group bg-white p-6 rounded-2xl shadow-sm border border-gray-200 hover:shadow-xl hover:border-blue-400 transition-all duration-300 transform hover:-translate-y-2">
                <div class="flex items-center space-x-4">
                    <div
                        class="p-4 bg-blue-100 text-blue-600 rounded-xl group-hover:bg-blue-600 group-hover:text-white transition-colors">
               ...
               class="group bg-white p-6 rounded-2xl shadow-sm border border-gray-200 hover:shadow-xl hover:border-blue-400 transition-all duration-300 transform hover:-translate-y-2">
                <div class="flex items-center space-x-4">
                    ...
                    <div>
                        ...
                        <p class="text-sm text-gray-500">Consulta y sube tus tareas.</p>
                    </div>
                </div>
                <div class="mt-4 flex items-center text-blue-600 font-semibold text-sm">
                    Gestionar módulo <i class="fas fa-arrow-right ml-2 group-hover:ml-4 transition-all"></i>
            ...
            <div class="relative group bg-gray-50 p-6 rounded-2xl border border-dashed border-gray-300 opacity-75">
                <div
                    class="absolute top-3 right-3 bg-gray-200 text-gray-600 text-[10px] font-bold px-2 py-0.5 rounded-full uppercase">
                    Próximamente
                </div>
                <div class="flex items-center space-x-4">
